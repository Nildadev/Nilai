  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 z-logo text-bolt-elements-textPrimary cursor-pointer group">
        ...
        <a href="/" className="text-2xl font-[800] flex items-center tracking-tight transition-all hover:drop-shadow-[0_0_10px_rgba(14,165,233,0.5)] py-1" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
          <span className="shimmer uppercase">nil</span>
          <span className="text-sky-500 mx-0.5">.</span>
