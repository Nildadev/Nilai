              ...
              >
                ...
                >
                  <svg className={classNames(styles.PromptEffectContainer)}>
                    <defs>
                      ...
                      >
                        ...
                        <stop offset="40%" stopColor="#0EA5E9" stopOpacity="80%"></stop>
                        <stop offset="50%" stopColor="#0EA5E9" stopOpacity="80%"></stop>
                  ...
                  <div>
                    <ClientOnly>
                      {() => (
                        <div className={isModelSettingsCollapsed ? 'hidden' : 'space-y-4 mb-4'}>
                          <ModelSelector
                  ...
                  >
                    <textarea
                      ...
                      placeholder="How can nil.ai help you today?"
                      translate="no"
                    />
                    <ClientOnly>
                      {() => (
