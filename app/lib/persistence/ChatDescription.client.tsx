        ...
        <form onSubmit={handleSubmit} className="flex items-center justify-center">
          ...
          <TooltipProvider>
            <WithTooltip tooltip="Save title">
              <div className="flex justify-between items-center p-2 rounded-[var(--bolt-border-radius-sm)] bg-bolt-elements-item-backgroundAccent">
                <button
                  type="submit"
        ...
        <>
          ...
          <TooltipProvider>
            <WithTooltip tooltip="Rename chat">
              <div className="flex justify-between items-center p-2 rounded-[var(--bolt-border-radius-sm)] bg-bolt-elements-item-backgroundAccent ml-2">
                <button
                  type="button"
