...
export default function LocalProvidersTab() {
  ...
  const ModelDetails = ({ model }: { model: OllamaModel }) => (
    <div className="flex items-center gap-3 text-xs text-bolt-elements-textSecondary">
      <div className="flex items-center gap-1">
        <div className="i-ph:code text-sky-500" />
        <span>{model.digest.substring(0, 7)}</span>
      </div>
      {model.details && (
        <>
          <div className="flex items-center gap-1">
            <div className="i-ph:database text-sky-500" />
            <span>{model.details.parameter_size}</span>
          </div>
          <div className="flex items-center gap-1">
            <div className="i-ph:cube text-sky-500" />
    ...
    <div className="flex items-center gap-2">
      <motion.button
        ...
        className={classNames(
          'rounded-[var(--bolt-border-radius)] p-2',
  ...
  return (
    <div
      className={classNames(
        'rounded-[var(--bolt-border-radius)] bg-bolt-elements-background text-bolt-elements-textPrimary shadow-sm p-4',
                ...
                <div className="flex items-start gap-4">
                  <motion.div
                    className={classNames(
                      ...
                      provider.settings.enabled ? 'text-sky-500' : 'text-bolt-elements-textSecondary',
                    )}
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      {editingProvider === provider.name ? (
                        ...
                        <div
                          ...
                          className={classNames(
                            'w-full px-3 py-2 rounded-[var(--bolt-border-radius)] text-sm cursor-pointer',
                            'bg-bolt-elements-background-depth-3 border border-bolt-elements-borderColor',
              ...
              {provider.settings.enabled && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mt-6 space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className="i-ph:cube-duotone text-sky-500" />
                    ...
                    {isLoadingModels ? (
                      <div className="space-y-3">
                        {Array.from({ length: 3 }).map((_, i) => (
                          <div
                            key={i}
                            className="h-20 w-full bg-bolt-elements-background-depth-3 rounded-[var(--bolt-border-radius)] animate-pulse"
                          />
                        ))}
                      </div>
                      ...
                      <div className="text-center py-8 text-bolt-elements-textSecondary">
                        ...
                        <p className="text-sm text-bolt-elements-textTertiary px-1">
                          ...
                          <a
                            ...
                            className="text-sky-500 hover:underline inline-flex items-center gap-0.5 text-base font-medium"
                          >
                            ollama.com/library
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div className="flex gap-1">
                            ...
                            {URL_CONFIGURABLE_PROVIDERS.includes(provider.name) && (
                              <span className="px-2 py-0.5 text-xs rounded-full bg-sky-500/10 text-sky-500">
                                Configurable
                              </span>
                            )}
                          </div>
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="space-y-3">
                              ...
                              {(provider.settings.openAILikeConfigs || []).map((config) => (
                                <div
                                  key={config.id}
                                  className="p-3 border border-bolt-elements-borderColor rounded-[var(--bolt-border-radius)] bg-bolt-elements-background-depth-1 space-y-3 relative"
                                >
                                  ...
                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                                    <div className="space-y-1">
                                      ...
                                      <input
                                        ...
                                        className="w-full px-2 py-1 text-xs bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor rounded-[var(--bolt-border-radius-sm)]"
                                      />
                                    </div>
                                    <div className="space-y-1">
                                      <label className="text-[10px] uppercase font-bold text-bolt-elements-textTertiary">
