  ...
  return (
    <DialogRoot open={open} onOpenChange={(v) => !v && onClose()}>
      <Dialog
        ...
        onClose={onClose}
      >
        <div className="border !border-bolt-elements-borderColor flex flex-col gap-5 justify-center items-center p-6 bg-bolt-elements-background-depth-2 rounded-[var(--bolt-border-radius-sm)]">
          ...
          <DialogDescription className="bg-bolt-elements-background-depth-3 max-w-sm rounded-[var(--bolt-border-radius-sm)] p-1 border border-bolt-elements-borderColor">
