    ...
    <AnimatePresence>
      <div
        className={classNames(
          ...
          'shadow-lg rounded-[var(--bolt-border-radius)]  relative w-full max-w-chat mx-auto z-prompt',
          'p-1',
        )}
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-[var(--bolt-border-radius)] text-bolt-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-[var(--bolt-border-radius)] bg-bolt-elements-item-backgroundAccent hover:bg-bolt-elements-artifacts-backgroundHover"
